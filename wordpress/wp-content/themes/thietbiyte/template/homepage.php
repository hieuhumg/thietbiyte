...
<?php //endwhile; wp_reset_postdata(); ?>
    ...
    <section id="wrapper">
            ...
            <div class="row it_CVUHKNWLNWBN custom-tabs mt-3">
                <div class="it_NEFMPOAKLBCJ col-12      custom-tab-links title-none text-uppercase">
                    ...
                    <div class="jxml-html custom-link ">
                        <h3 class="jxml-html-title">Sản phẩm nổi bật</h3>
                        <div class="jxml-html-description">
                            <p>Sản phẩm nổi bật</p>
                        </div>
                    </div>
                    <div class="jxml-html custom-link ">
                        <h3 class="jxml-html-title">Sản phẩm giảm giá</h3>
                        <div class="jxml-html-description">
                ...
                <div class="it_EVNYCVDNIXKF col-12      custom-tab-contents grid">
                    ...
                    <div class="module ">
                        <section class="special-products grid">
                            ...
                            <div class="products">
                                <?php if(count($post_noibat) > 0) {
                                    foreach ($post_noibat as $item) {
                                        $product_img = get_field('product_img', $item->ID);
                                        $product_price = get_field('product_price', $item->ID);
                                    ?>
        ...
        <div class="wrapper container-fluid chinhsach">
            <div class="list_product">
                <div class="">
                    <div class=" " data-offset="0" data-speed="0.8" data-type="media" data-fade="false"
                         data-url="<?= get_template_directory_uri() ?>/dist/images/bg-items.jpg" data-direction="normal"
                         style="position: fixed; background-image: url(<?= get_template_directory_uri() ?>/dist/images/bg-items.jpg); height: 648px; transform: translate3d(0px, -568.48px, 0px);"></div>
                    <div class=" " style="position: relative; height: 480px;">
                        <div class="" data-offset="0" data-speed="0" data-type="html" data-fade="false"
                             data-direction="normal">
                            <div class="container justify-content-center">
                                <div class="row">
                                    <div class=" col-12      px-0 fixed">
            ...
            <div class="row it_PQQWEBQSPNEI mt-5">
                <div class="it_DGDNXQZLQZSR col-12      ">
                    <div class="jxml-html blog_title_block text-center">
                        ...
                        <div class="jxml-html-description">
                            <h4 class="blog_title_block text-uppercase"><a
                                        href="https://ld-prestashop.template-help.com/prestashop_22327/index.phpfc=module&amp;module=jxblog&amp;controller=categories">Bài viết nổi bật</a></h4>
                        </div>
                    </div>
                </div>
                <?php
                //lấy bài viết nổi bật
                $bai_viet_noi_bat = get_field('bai_viet_noi_bat');
                foreach ($bai_viet_noi_bat as $value) {
                ?>
                        ...
                        <div class="bp-miniature-container">
                            ...
                            <div class="bp-info text-center">
                                ...
                                <p class="post-meta mb-3">
                                    <?= $value['chon_bai_viet']->post_date;  ?>
<!--                                    <em>Views (183)</em>-->
                                </p>

                                <p class="h2 bp-name d-none d-xl-block">
                                    <a href="https://ld-prestashop.template-help.com/prestashop_22327/index.php?fc=module&amp;module=jxblog&amp;id_jxblog_post=1&amp;controller=post&amp;id_lang=1">
                                        <?= $value['chon_bai_viet']->post_title;  ?>
                                    </a>
                                </p>

                                <div class="bp-short-description mb-3 d-none d-xl-block">
                                    <p><?= wp_trim_words( $value['chon_bai_viet']->post_content, 40, '...' ); ?></p>
                                </div>
                                <a class="btn"
                                   href="<?= the_permalink($value['chon_bai_viet']->ID) ?>">
                                    Xem thêm
                                </a>
                            </div>
                        </div>
